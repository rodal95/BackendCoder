...
import { ContenedorArchivoProd } from "./contenedorArchivoProd";

const { get } = require('https');

class ContenedorArchivoCart {

    constructor(cartFile,productFile){
        this.productManager = new ContenedorArchivoProd(productFile);
